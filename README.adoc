...
* *Cirrus* image:https://api.cirrus-ci.com/github/gAmUssA/testcontainers-java-module-confluent-platform.svg["Build Status, link="https://cirrus-ci.com/github/gAmUssA/testcontainers-java-module-confluent-platform"]
